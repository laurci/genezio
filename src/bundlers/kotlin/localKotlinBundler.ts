...
import { template } from "./kotlinMain";
import { castArrayRecursivelyInitial, castMapRecursivelyInitial } from "../../utils/kotlinAstCasting";
...
import { ArrayType, AstNodeType, ClassDefinition, CustomAstNodeType, MapType, Node, Program } from "../../models/genezioModels";
...
export class KotlinBundler implements BundlerInterface {
  ...
  async bundle(input: BundlerInput): Promise<BundlerOutput> {
    ...
    // Check if Kotlin and its requirements are installed
    ...
    return {
      ...
      extra: {
        ...
        commandParameters: ["-jar", inputTemporaryFolder + "/final_build/app-standalone.jar"],
      }
    };
  }
}
